...
export const metadata: Metadata = {
  title: "Blog — Crypto Intelligence & Market Analysis",
  description:
    "In-depth crypto market analysis, trading psychology insights, and AI-powered intelligence reports from the AI Trading Copilot team.",
};
...
const posts = [
  {
    ...
    excerpt: "We detected an 87% structural match to the 2020 halving cycle 3 weeks before BTC broke $70K. Full analysis inside.",
  ...
  },
  {
    ...
    excerpt: "How to use whale accumulation signals and narrative strength to spot new listing opportunities.",
    category: "Strategy",
